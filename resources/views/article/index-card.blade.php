        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <img src="{{ asset('storage/' . $article->image) }}" class="card-img-top" alt="Immagine Articolo" style="height: 200px; object-fit: cover;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('articles.show', $article->id) }}" class="btn btn-primary mt-auto">Leggi di più</a>
                    </div>
